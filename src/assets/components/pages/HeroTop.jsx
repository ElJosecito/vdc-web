  ...
  return (
    <div className='md:flex justify-between items-center pt-10 md:relative'>
      <div className='lg:w-1/2 px-5'>
        <h1 className='lg:text-6xl text-4xl font-bold text-brand md:absolute z-10 '>
        ...
        <div className='flex mt-7'>
          <motion.button whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }} className='bg-primary text-white rounded-xl p-4 font-semibold'>{t('hero.bookAppointment')}</motion.button>
          <div className='flex items-center md:ml-8 ml-2'>
            <div className='border-2 rounded-xl p-1 border-info'>
              <div className='bg-gradient-to-b from-accent to-white text-primary rounded-lg w-9 h-9 md:w-12 md:h-12 flex justify-center items-center'>
                <LucideIcon name='PhoneCall' size={20} className='text-primary' />
              </div>
            </div>
            <div className='ml-2 md:ml-4 w-full'>
              <p className='text-brand font-semibold text-sm'>{t('hero.callUsNow')}</p>
          ...
          <p className='mt-4 text-brand text-sm pl-2 font-medium'>{t('profile.note')}</p>
        </motion.div>
      </div>
